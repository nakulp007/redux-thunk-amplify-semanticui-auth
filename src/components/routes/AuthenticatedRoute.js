...
/*
This component is similar to the AppliedRoute component. The main difference being that 
we look at the props that are passed in to check if a user is authenticated. If the user 
